...
def build(collection: SignalCollection, config: dict) -> str:
    ...
    lines = [
        ...
        "2. Select the 5–6 most compelling items for a live stream audience interested in AI.",
    ...
    lines += [
        ...
        "- **Type:** Breakthrough / Interesting / Thought Leader / General News",
        "- **Why it matters:** 2–3 sentences explaining the significance.",
        "- **Stream hook:** 1–2 conversational sentences to open this segment on air.",
        "- **Audience:** [comma-separated content lenses that apply]",
        "- **URL:** [Direct link](url)",
        "",
        "### 2. [Headline]",
        "*(repeat card format)*",
